...
class Signup extends React.Component {
    ...
    $('#signup-form').form({
      ...
      fields: {
        ...
        password: {
          ...
          rules: [
            { type: 'minLength[8]',
              prompt: 'Please enter a password with at least {ruleValue} alphanumeric characters' },
        ...
        passwordConfirm: {
          ...
          rules: [
            { type: 'match[password-input]',
              prompt: 'Passwords need to match'}
          ]
        },
        firstName: {
        ...
        terms: {
          ...
          rules: [
            { type: 'checked',
              prompt: 'Please read and agree to the terms and conditions' }
          ]
        },
      }
    });
  ...
  handleSubmit(event) {
    ...
    if ($('#signup-form').form('is valid')) {
      ...
      SignupActions.createUser(email, password, firstName, lastName, city, country, this.props.history);
    } else {
      return false;
    };
  };
      ...
      <div className='ten wide column'>
        <form id='signup-form' className='ui form' onSubmit={this.handleSubmit.bind(this)}>
          ...
          <div className='required field'>
            <label>Email</label>
            <input name='email' placeholder='example@examples.com' value={this.state.email} onChange={SignupActions.updateEmail} />
          </div>
          <div className='required field'>
            <label>Password</label>
            <input type='password' name='password-input' placeholder='examplepassword1' value={this.state.password} onChange={SignupActions.updatePassword} />
          </div>
          <div className='required field'>
            <label>Confirm password</label>
            <input type='password' name='password-confirm' placeholder='examplepassword1' />
          </div>
          <div className='required field'>
            <label>Name</label>
            <div className='two fields'>
              <div className='field'>
                <input type='text' name='first-name' placeholder='First Name' value={this.state.firstName} onChange={SignupActions.updateFirstName} />
              </div>
              <div className='field'>
                <input type='text' name='last-name' placeholder='Last Name' value={this.state.lastName} onChange={SignupActions.updateLastName} />
              </div>
            </div>
          </div>
          <div className='required field'>
            ...
            <div className='two fields'>
              <div className='field'>
                <input type='text' name='city' placeholder='City' value={this.state.city} onChange={SignupActions.updateCity} />
              </div>
              <div className='field' onBlur={SignupActions.updateCountry} >
                <div className='ui fluid search selection dropdown'>
                  <input id='signup-country' type='hidden' name='country' value={this.state.country} />
